...
public class FleeAgent : Agent
{
    ...
    { 
        ...
        forceFlee.x = actionBuffers.ContinuousActions[0]; //x direction of force that needs to be applied. 
        forceFlee.z = actionBuffers.ContinuousActions[1];//z direction of force
        ...
        //rBody.AddForce(forceFlee* forceMultiplier);//Add that force to the rigidbody that is the agent
    }
